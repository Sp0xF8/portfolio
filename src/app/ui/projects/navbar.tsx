	...
	return (
		...
		<div className="rounded-right bg-gray-800 w-64 h-full flex flex-col justify-between">
			...
			<div className="flex h-full flex-col px-3 py-4 md:px-2">
				...
				<div className="flex-none w-full bg-gray-900 flex items-center justify-center text-1xl font-bold text-orange-500 h-8">

					<Link key={"addProject"} href="/projects/new" className=" flex-none h-10 w-full bg-gray-900 flex items-center justify-center text-2xl font-bold text-orange-500"> 
